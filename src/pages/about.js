...
<Layout>
  <SEO title="About" />
    ...
    <p>For his final project in computer engineering, he combined his interest for trying new technologies and Unity development by making a project to control a vehicle with hand movements using Leap Motion and showing it on a VR headset.Project page is <Link to="/project/operator/">here</Link>.</p>
    ...
    <hr></hr>
    <p>His passion of game development encouraged him to learn different platforms (Unity, Construct 2, etc...) and develop small games to test his skills. He also attended various events to further widen his perspective of game development.</p>
    <p>Peak Games Unithon was the most recent event he attended, where he was part of group of seven that designed a game, its product plan and marketing strategy. His group was honoured the first place among dozen groups. Presentation of their project is <a href="https://res.cloudinary.com/chiv/image/upload/v1570492607/pdfs/Wild_Animal_Chase_cz23m1.pdf"  target="_blank">here</a>. </p>
    <hr></hr>
    <p>For his first internship, he worked with MBIS Danışmanlık to gain experience on SAP. As a ABAP programmer, he implemented interactive ALVs to increase workflow and designed SmartForms to automate generating print-ready reports. Detailed report of the internship is <a href="https://res.cloudinary.com/chiv/image/upload/v1570492606/pdfs/SAP_ABAP_Programming_for_MBIS_Dansmanlk_dfk7g3.pdf"  target="_blank">here</a>.</p>
